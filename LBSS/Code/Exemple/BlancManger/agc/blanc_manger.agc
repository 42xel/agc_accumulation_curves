...
To generate, put:
toAGC_ubt ./agc/.anonymous_machine.agc ./agc/.anonymous_config.agc ./agc/blanc_manger.agc
in a .lbss file and run it with lbss.py

usage:
java -jar agc_2_0.jar ./agc/blanc_manger.agc
*/
...
r.export ("PDF","./pdf/blanc_manger.pdf",{
	scale := SCALE;
	}
);
