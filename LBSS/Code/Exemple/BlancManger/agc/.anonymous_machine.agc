...
anonymous_machine .= create_signal_machine()
{
	...
	list_node_output_Left := list_node_output_Left _ [[]];
	create_mscr_get(1, "cell");
	add_meta_signal(create_id_node_aux("Left_#6"), 0)	{color => COLOR_COMPUTE;};
	...
	list_node_output_Left := list_node_output_Left _ [[]];
	create_mscr_get(2, "cell");
	add_meta_signal(create_id_node_aux("Left_#13"), 0)	{color => COLOR_COMPUTE;};

	create_mscr_node("Left_#14");
	list_node_output_Left := list_node_output_Left _ [[]];

	create_mscr_node("Left_#15");
	list_node_output_Left := list_node_output_Left _ [[]];

	create_mscr_node("Left_#16");
	list_node_output_Left := list_node_output_Left _ [[]];
	create_mscr_get(1, "accu");
	add_meta_signal(create_id_node_aux("Left_#16"), 0)	{color => COLOR_COMPUTE;};

	create_mscr_node("Left_#17");
	list_node_output_Left := list_node_output_Left _ [[]];

	create_mscr_node("Left_#18");
	list_node_output_Left := list_node_output_Left _ [[]];

	create_mscr_node("Left_#19");
	list_node_output_Left := list_node_output_Left _ [[]];
	create_mscr_get(2, "cell");
	add_meta_signal(create_id_node_aux("Left_#19"), 0)	{color => COLOR_COMPUTE;};

	create_mscr_node("Left_#20");
	list_node_output_Left := list_node_output_Left _ [[]];
    create_mscr_move("<", 3);

	create_mscr_node("Left_#21");
	list_node_output_Left := list_node_output_Left _ [[]];
	create_mscr_get(1, "cell");
	add_meta_signal(create_id_node_aux("Left_#21"), 0)	{color => COLOR_COMPUTE;};

	create_mscr_node("Left_#22");
	list_node_output_Left := list_node_output_Left _ [[]];
	create_mscr_get(1, "cell");
	add_meta_signal(create_id_node_aux("Left_#22"), 0)	{color => COLOR_COMPUTE;};

	create_mscr_node("Left_#23");
	list_node_output_Left := list_node_output_Left _ [[]];

	create_mscr_node("Left_#24");
	list_node_output_Left := list_node_output_Left _ [[]];
	create_mscr_get(1, "accu");
	add_meta_signal(create_id_node_aux("Left_#24"), 0)	{color => COLOR_COMPUTE;};

	create_mscr_node("Left_#25");
	list_node_output_Left := list_node_output_Left _ [[]];
	...
	list_node_output_Right := list_node_output_Right _ [[]];
	create_mscr_get(1, "cell");
	add_meta_signal(create_id_node_aux("Right_#6"), 0)	{color => COLOR_COMPUTE;};
	...
	list_node_output_Right := list_node_output_Right _ [[]];
	create_mscr_get(2, "cell");
	add_meta_signal(create_id_node_aux("Right_#13"), 0)	{color => COLOR_COMPUTE;};

	create_mscr_node("Right_#14");
	list_node_output_Right := list_node_output_Right _ [[]];

	create_mscr_node("Right_#15");
	list_node_output_Right := list_node_output_Right _ [[]];

	create_mscr_node("Right_#16");
	list_node_output_Right := list_node_output_Right _ [[]];
	create_mscr_get(1, "accu");
	add_meta_signal(create_id_node_aux("Right_#16"), 0)	{color => COLOR_COMPUTE;};

	create_mscr_node("Right_#17");
	list_node_output_Right := list_node_output_Right _ [[]];
    create_mscr_move(">", 3);

	create_mscr_node("Right_#18");
	list_node_output_Right := list_node_output_Right _ [[]];

	create_mscr_node("Right_#19");
	list_node_output_Right := list_node_output_Right _ [[]];
	create_mscr_get(2, "cell");
	add_meta_signal(create_id_node_aux("Right_#19"), 0)	{color => COLOR_COMPUTE;};

	create_mscr_node("Right_#20");
	list_node_output_Right := list_node_output_Right _ [[]];

	create_mscr_node("Right_#21");
	list_node_output_Right := list_node_output_Right _ [[]];
	create_mscr_get(1, "cell");
	add_meta_signal(create_id_node_aux("Right_#21"), 0)	{color => COLOR_COMPUTE;};

	create_mscr_node("Right_#22");
	list_node_output_Right := list_node_output_Right _ [[]];
	create_mscr_get(1, "cell");
	add_meta_signal(create_id_node_aux("Right_#22"), 0)	{color => COLOR_COMPUTE;};

	create_mscr_node("Right_#23");
	list_node_output_Right := list_node_output_Right _ [[]];

	create_mscr_node("Right_#24");
	list_node_output_Right := list_node_output_Right _ [[]];
	create_mscr_get(1, "accu");
	add_meta_signal(create_id_node_aux("Right_#24"), 0)	{color => COLOR_COMPUTE;};

	create_mscr_node("Right_#25");
	list_node_output_Right := list_node_output_Right _ [[]];
	...
	list_node_output_Init[9] := [create_id_node("Init_#9"), create_id_get (1/4, "accu", 0)];
	...
	list_node_output_Left[4] := [create_id_node("Left_#4"), create_id_get (2, "cell", 0)];

	//get result positive (v received before z)
	[create_id_node("Left_#4"), create_id_return("v")] --> [create_id_node_aux("Left_#4"), create_id_sub("accu", "bot", 0)];
	[create_id_node_aux("Left_#4"), create_id_return("z")] --> [create_id_node("Left_#4"), create_id_sub("accu", "top", 0)];
	//get result negative (z received before v)
	[create_id_node("Left_#4"), create_id_return("z")] --> [create_id_node_aux("Left_#4"), create_id_add("accu", 0)];
	[create_id_node_aux("Left_#4"), create_id_return("v")] --> [create_id_node("Left_#4"), create_id_add("accu", 0)];

	list_node_output_Left[5] := [create_id_node("Left_#5"), create_id_move_init_n(">", 1)];

	list_node_output_Left[6] := [create_id_node("Left_#6"), create_id_get (1, "cell", 0)];

	//get result positive (v received before z)
	[create_id_node("Left_#6"), create_id_return("v")] --> [create_id_node_aux("Left_#6"), create_id_add("accu", 0)];
	[create_id_node_aux("Left_#6"), create_id_return("z")] --> [create_id_node("Left_#6"), create_id_add("accu", 0)];
	//get result negative (z received before v)
	[create_id_node("Left_#6"), create_id_return("z")] --> [create_id_node_aux("Left_#6"), create_id_sub("accu", "bot", 0)];
	[create_id_node_aux("Left_#6"), create_id_return("v")] --> [create_id_node("Left_#6"), create_id_sub("accu", "top", 0)];

	list_node_output_Left[7] := [create_id_node("Left_#7"), create_id_move_init_n(">", 1)];

	list_node_output_Left[8] := [create_id_node("Left_#8"), create_id_reset("cell")];

	list_node_output_Left[9] := [create_id_node("Left_#9"), create_id_get (1/4, "accu", 0)];

	//get result positive (v received before z)
	[create_id_node("Left_#9"), create_id_return("v")] --> [create_id_node_aux("Left_#9"), create_id_add("cell", 0)];
	[create_id_node_aux("Left_#9"), create_id_return("z")] --> [create_id_node("Left_#9"), create_id_add("cell", 0)];
	//get result negative (z received before v)
	[create_id_node("Left_#9"), create_id_return("z")] --> [create_id_node_aux("Left_#9"), create_id_sub("cell", "bot", 0)];
	[create_id_node_aux("Left_#9"), create_id_return("v")] --> [create_id_node("Left_#9"), create_id_sub("cell", "top", 0)];

	list_node_output_Left[10] := [create_id_node("Left_#10"), create_id_reset("accu")];

	list_node_output_Left[11] := [create_id_node("Left_#11"), create_id_move_init_n("<", 2)];

	list_node_output_Left[12] := [create_id_node("Left_#12"), create_id_reset("accu")];

	list_node_output_Left[13] := [create_id_node("Left_#13"), create_id_get (2, "cell", 0)];

	//get result positive (v received before z)
	[create_id_node("Left_#13"), create_id_return("v")] --> [create_id_node_aux("Left_#13"), create_id_add("accu", 0)];
	[create_id_node_aux("Left_#13"), create_id_return("z")] --> [create_id_node("Left_#13"), create_id_add("accu", 0)];
	//get result negative (z received before v)
	[create_id_node("Left_#13"), create_id_return("z")] --> [create_id_node_aux("Left_#13"), create_id_sub("accu", "bot", 0)];
	[create_id_node_aux("Left_#13"), create_id_return("v")] --> [create_id_node("Left_#13"), create_id_sub("accu", "top", 0)];

	list_node_output_Left[14] := [create_id_node("Left_#14"), create_id_move_init_n(">", 1)];

	list_node_output_Left[15] := [create_id_node("Left_#15"), create_id_reset("cell")];

	list_node_output_Left[16] := [create_id_node("Left_#16"), create_id_get (1, "accu", 0)];

	//get result positive (v received before z)
	[create_id_node("Left_#16"), create_id_return("v")] --> [create_id_node_aux("Left_#16"), create_id_add("cell", 0)];
	[create_id_node_aux("Left_#16"), create_id_return("z")] --> [create_id_node("Left_#16"), create_id_add("cell", 0)];
	//get result negative (z received before v)
	[create_id_node("Left_#16"), create_id_return("z")] --> [create_id_node_aux("Left_#16"), create_id_sub("cell", "bot", 0)];
	[create_id_node_aux("Left_#16"), create_id_return("v")] --> [create_id_node("Left_#16"), create_id_sub("cell", "top", 0)];

	list_node_output_Left[17] := [create_id_node("Left_#17"), create_id_move_init_n(">", 1)];

	list_node_output_Left[18] := [create_id_node("Left_#18"), create_id_reset("accu")];

	list_node_output_Left[19] := [create_id_node("Left_#19"), create_id_get (2, "cell", 0)];

	//get result positive (v received before z)
	[create_id_node("Left_#19"), create_id_return("v")] --> [create_id_node_aux("Left_#19"), create_id_sub("accu", "bot", 0)];
	[create_id_node_aux("Left_#19"), create_id_return("z")] --> [create_id_node("Left_#19"), create_id_sub("accu", "top", 0)];
	//get result negative (z received before v)
	[create_id_node("Left_#19"), create_id_return("z")] --> [create_id_node_aux("Left_#19"), create_id_add("accu", 0)];
	[create_id_node_aux("Left_#19"), create_id_return("v")] --> [create_id_node("Left_#19"), create_id_add("accu", 0)];

	list_node_output_Left[20] := [create_id_node("Left_#20"), create_id_move_init_n("<", 3)];

	list_node_output_Left[21] := [create_id_node("Left_#21"), create_id_get (1, "cell", 0)];

	//get result positive (v received before z)
	[create_id_node("Left_#21"), create_id_return("v")] --> [create_id_node_aux("Left_#21"), create_id_add("accu", 0)];
	[create_id_node_aux("Left_#21"), create_id_return("z")] --> [create_id_node("Left_#21"), create_id_add("accu", 0)];
	//get result negative (z received before v)
	[create_id_node("Left_#21"), create_id_return("z")] --> [create_id_node_aux("Left_#21"), create_id_sub("accu", "bot", 0)];
	[create_id_node_aux("Left_#21"), create_id_return("v")] --> [create_id_node("Left_#21"), create_id_sub("accu", "top", 0)];

	list_node_output_Left[22] := [create_id_node("Left_#22"), create_id_get (1, "cell", 0)];

	//get result positive (v received before z)
	[create_id_node("Left_#22"), create_id_return("v")] --> [create_id_node_aux("Left_#22"), create_id_add("cell", 0)];
	[create_id_node_aux("Left_#22"), create_id_return("z")] --> [create_id_node("Left_#22"), create_id_add("cell", 0)];
	//get result negative (z received before v)
	[create_id_node("Left_#22"), create_id_return("z")] --> [create_id_node_aux("Left_#22"), create_id_sub("cell", "bot", 0)];
	[create_id_node_aux("Left_#22"), create_id_return("v")] --> [create_id_node("Left_#22"), create_id_sub("cell", "top", 0)];

	list_node_output_Left[23] := [create_id_node("Left_#23"), create_id_move_init_n(">", 1)];

	list_node_output_Left[24] := [create_id_node("Left_#24"), create_id_get (1, "accu", 0)];

	//get result positive (v received before z)
	[create_id_node("Left_#24"), create_id_return("v")] --> [create_id_node_aux("Left_#24"), create_id_add("cell", 0)];
	[create_id_node_aux("Left_#24"), create_id_return("z")] --> [create_id_node("Left_#24"), create_id_add("cell", 0)];
	//get result negative (z received before v)
	[create_id_node("Left_#24"), create_id_return("z")] --> [create_id_node_aux("Left_#24"), create_id_sub("cell", "bot", 0)];
	[create_id_node_aux("Left_#24"), create_id_return("v")] --> [create_id_node("Left_#24"), create_id_sub("cell", "top", 0)];

	list_node_output_Left[25] := [create_id_node("Left_#25"), create_id_reset("accu")];
	...
	list_node_output_Right[3] := [create_id_node("Right_#3"), create_id_move_init_n(">", 1)];

	list_node_output_Right[4] := [create_id_node("Right_#4"), create_id_get (2, "cell", 0)];

	//get result positive (v received before z)
	[create_id_node("Right_#4"), create_id_return("v")] --> [create_id_node_aux("Right_#4"), create_id_sub("accu", "bot", 0)];
	[create_id_node_aux("Right_#4"), create_id_return("z")] --> [create_id_node("Right_#4"), create_id_sub("accu", "top", 0)];
	//get result negative (z received before v)
	[create_id_node("Right_#4"), create_id_return("z")] --> [create_id_node_aux("Right_#4"), create_id_add("accu", 0)];
	[create_id_node_aux("Right_#4"), create_id_return("v")] --> [create_id_node("Right_#4"), create_id_add("accu", 0)];

	list_node_output_Right[5] := [create_id_node("Right_#5"), create_id_move_init_n(">", 1)];

	list_node_output_Right[6] := [create_id_node("Right_#6"), create_id_get (1, "cell", 0)];

	//get result positive (v received before z)
	[create_id_node("Right_#6"), create_id_return("v")] --> [create_id_node_aux("Right_#6"), create_id_add("accu", 0)];
	[create_id_node_aux("Right_#6"), create_id_return("z")] --> [create_id_node("Right_#6"), create_id_add("accu", 0)];
	//get result negative (z received before v)
	[create_id_node("Right_#6"), create_id_return("z")] --> [create_id_node_aux("Right_#6"), create_id_sub("accu", "bot", 0)];
	[create_id_node_aux("Right_#6"), create_id_return("v")] --> [create_id_node("Right_#6"), create_id_sub("accu", "top", 0)];

	list_node_output_Right[7] := [create_id_node("Right_#7"), create_id_move_init_n(">", 1)];

	list_node_output_Right[8] := [create_id_node("Right_#8"), create_id_reset("cell")];

	list_node_output_Right[9] := [create_id_node("Right_#9"), create_id_get (1/4, "accu", 0)];

	//get result positive (v received before z)
	[create_id_node("Right_#9"), create_id_return("v")] --> [create_id_node_aux("Right_#9"), create_id_add("cell", 0)];
	[create_id_node_aux("Right_#9"), create_id_return("z")] --> [create_id_node("Right_#9"), create_id_add("cell", 0)];
	//get result negative (z received before v)
	[create_id_node("Right_#9"), create_id_return("z")] --> [create_id_node_aux("Right_#9"), create_id_sub("cell", "bot", 0)];
	[create_id_node_aux("Right_#9"), create_id_return("v")] --> [create_id_node("Right_#9"), create_id_sub("cell", "top", 0)];

	list_node_output_Right[10] := [create_id_node("Right_#10"), create_id_reset("accu")];

	list_node_output_Right[11] := [create_id_node("Right_#11"), create_id_move_init_n("<", 2)];

	list_node_output_Right[12] := [create_id_node("Right_#12"), create_id_reset("accu")];

	list_node_output_Right[13] := [create_id_node("Right_#13"), create_id_get (2, "cell", 0)];

	//get result positive (v received before z)
	[create_id_node("Right_#13"), create_id_return("v")] --> [create_id_node_aux("Right_#13"), create_id_add("accu", 0)];
	[create_id_node_aux("Right_#13"), create_id_return("z")] --> [create_id_node("Right_#13"), create_id_add("accu", 0)];
	//get result negative (z received before v)
	[create_id_node("Right_#13"), create_id_return("z")] --> [create_id_node_aux("Right_#13"), create_id_sub("accu", "bot", 0)];
	[create_id_node_aux("Right_#13"), create_id_return("v")] --> [create_id_node("Right_#13"), create_id_sub("accu", "top", 0)];

	list_node_output_Right[14] := [create_id_node("Right_#14"), create_id_move_init_n("<", 1)];

	list_node_output_Right[15] := [create_id_node("Right_#15"), create_id_reset("cell")];

	list_node_output_Right[16] := [create_id_node("Right_#16"), create_id_get (1, "accu", 0)];

	//get result positive (v received before z)
	[create_id_node("Right_#16"), create_id_return("v")] --> [create_id_node_aux("Right_#16"), create_id_add("cell", 0)];
	[create_id_node_aux("Right_#16"), create_id_return("z")] --> [create_id_node("Right_#16"), create_id_add("cell", 0)];
	//get result negative (z received before v)
	[create_id_node("Right_#16"), create_id_return("z")] --> [create_id_node_aux("Right_#16"), create_id_sub("cell", "bot", 0)];
	[create_id_node_aux("Right_#16"), create_id_return("v")] --> [create_id_node("Right_#16"), create_id_sub("cell", "top", 0)];

	list_node_output_Right[17] := [create_id_node("Right_#17"), create_id_move_init_n(">", 3)];

	list_node_output_Right[18] := [create_id_node("Right_#18"), create_id_reset("accu")];

	list_node_output_Right[19] := [create_id_node("Right_#19"), create_id_get (2, "cell", 0)];

	//get result positive (v received before z)
	[create_id_node("Right_#19"), create_id_return("v")] --> [create_id_node_aux("Right_#19"), create_id_sub("accu", "bot", 0)];
	[create_id_node_aux("Right_#19"), create_id_return("z")] --> [create_id_node("Right_#19"), create_id_sub("accu", "top", 0)];
	//get result negative (z received before v)
	[create_id_node("Right_#19"), create_id_return("z")] --> [create_id_node_aux("Right_#19"), create_id_add("accu", 0)];
	[create_id_node_aux("Right_#19"), create_id_return("v")] --> [create_id_node("Right_#19"), create_id_add("accu", 0)];

	list_node_output_Right[20] := [create_id_node("Right_#20"), create_id_move_init_n("<", 1)];

	list_node_output_Right[21] := [create_id_node("Right_#21"), create_id_get (1, "cell", 0)];

	//get result positive (v received before z)
	[create_id_node("Right_#21"), create_id_return("v")] --> [create_id_node_aux("Right_#21"), create_id_add("accu", 0)];
	[create_id_node_aux("Right_#21"), create_id_return("z")] --> [create_id_node("Right_#21"), create_id_add("accu", 0)];
	//get result negative (z received before v)
	[create_id_node("Right_#21"), create_id_return("z")] --> [create_id_node_aux("Right_#21"), create_id_sub("accu", "bot", 0)];
	[create_id_node_aux("Right_#21"), create_id_return("v")] --> [create_id_node("Right_#21"), create_id_sub("accu", "top", 0)];

	list_node_output_Right[22] := [create_id_node("Right_#22"), create_id_get (1, "cell", 0)];

	//get result positive (v received before z)
	[create_id_node("Right_#22"), create_id_return("v")] --> [create_id_node_aux("Right_#22"), create_id_add("cell", 0)];
	[create_id_node_aux("Right_#22"), create_id_return("z")] --> [create_id_node("Right_#22"), create_id_add("cell", 0)];
	//get result negative (z received before v)
	[create_id_node("Right_#22"), create_id_return("z")] --> [create_id_node_aux("Right_#22"), create_id_sub("cell", "bot", 0)];
	[create_id_node_aux("Right_#22"), create_id_return("v")] --> [create_id_node("Right_#22"), create_id_sub("cell", "top", 0)];

	list_node_output_Right[23] := [create_id_node("Right_#23"), create_id_move_init_n("<", 1)];

	list_node_output_Right[24] := [create_id_node("Right_#24"), create_id_get (1, "accu", 0)];

	//get result positive (v received before z)
	[create_id_node("Right_#24"), create_id_return("v")] --> [create_id_node_aux("Right_#24"), create_id_add("cell", 0)];
	[create_id_node_aux("Right_#24"), create_id_return("z")] --> [create_id_node("Right_#24"), create_id_add("cell", 0)];
	//get result negative (z received before v)
	[create_id_node("Right_#24"), create_id_return("z")] --> [create_id_node_aux("Right_#24"), create_id_sub("cell", "bot", 0)];
	[create_id_node_aux("Right_#24"), create_id_return("v")] --> [create_id_node("Right_#24"), create_id_sub("cell", "top", 0)];

	list_node_output_Right[25] := [create_id_node("Right_#25"), create_id_reset("accu")];
	...
	list_node_output_LSplit[0] := [create_id_node("LSplit_#0"), create_id_ubt ("split")];

	list_node_output_LSplit[1] := [create_id_node("LSplit_#1")];
	...
	[create_id_node("Left_#13"), create_id_return("")] --> list_node_output_Left[14];
	[create_id_node("Left_#14"), create_id_return("")] --> list_node_output_Left[15];
	[create_id_node("Left_#15"), create_id_return("")] --> list_node_output_Left[16];
	[create_id_node("Left_#16"), create_id_return("")] --> list_node_output_Left[17];
	[create_id_node("Left_#17"), create_id_return("")] --> list_node_output_Left[18];
	[create_id_node("Left_#18"), create_id_return("")] --> list_node_output_Left[19];
	[create_id_node("Left_#19"), create_id_return("")] --> list_node_output_Left[20];
	[create_id_node("Left_#20"), create_id_return("")] --> list_node_output_Left[21];
	[create_id_node("Left_#21"), create_id_return("")] --> list_node_output_Left[22];
	[create_id_node("Left_#22"), create_id_return("")] --> list_node_output_Left[23];
	[create_id_node("Left_#23"), create_id_return("")] --> list_node_output_Left[24];
	[create_id_node("Left_#24"), create_id_return("")] --> list_node_output_Left[25];
	[create_id_node("Left_#25"), create_id_return("")] --> list_node_output_Up[0];
	...
	[create_id_node("Right_#13"), create_id_return("")] --> list_node_output_Right[14];
	[create_id_node("Right_#14"), create_id_return("")] --> list_node_output_Right[15];
	[create_id_node("Right_#15"), create_id_return("")] --> list_node_output_Right[16];
	[create_id_node("Right_#16"), create_id_return("")] --> list_node_output_Right[17];
	[create_id_node("Right_#17"), create_id_return("")] --> list_node_output_Right[18];
	[create_id_node("Right_#18"), create_id_return("")] --> list_node_output_Right[19];
	[create_id_node("Right_#19"), create_id_return("")] --> list_node_output_Right[20];
	[create_id_node("Right_#20"), create_id_return("")] --> list_node_output_Right[21];
	[create_id_node("Right_#21"), create_id_return("")] --> list_node_output_Right[22];
	[create_id_node("Right_#22"), create_id_return("")] --> list_node_output_Right[23];
	[create_id_node("Right_#23"), create_id_return("")] --> list_node_output_Right[24];
	[create_id_node("Right_#24"), create_id_return("")] --> list_node_output_Right[25];
	[create_id_node("Right_#25"), create_id_return("")] --> list_node_output_Up[0];
	...
	list_cr_split := list_cr_split _ [[[create_id_node("LSplit_#0")],
